 ...
 *      v2      =   Vectorize by 4
 *      FMA3    =   FMA3 Instruction Set
 * 
 */

#ifndef _flops_bench_f64v2_FMA3_H
#define _flops_bench_f64v2_FMA3_H

...
////////////////////////////////////////////////////////////////////////////////
//  Fused Multiply Add
class bench_fma_linear_f64v2_FMA3_chains12 : public benchmark{
    virtual void print_meta() const{
        cout << "Double-Precision - 256-bit FMA3 - Fused Multiply Add:" << endl;

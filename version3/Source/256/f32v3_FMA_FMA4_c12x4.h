...
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
class f32v3_FMA_FMA4_c12x4 : public Benchmark{
public:
    f32v3_FMA_FMA4_c12x4()
        : Benchmark(48 * 2 * 8)
    {}
    virtual double run_kernel(size_t iterations) const override{
        ...
        do{
            r0 = _mm256_macc_ps(mul0, mul1, r0);
            r1 = _mm256_macc_ps(mul0, mul1, r1);
            r2 = _mm256_macc_ps(mul0, mul1, r2);
            r3 = _mm256_macc_ps(mul0, mul1, r3);
            r4 = _mm256_macc_ps(mul0, mul1, r4);
            r5 = _mm256_macc_ps(mul0, mul1, r5);
            r6 = _mm256_macc_ps(mul0, mul1, r6);
            r7 = _mm256_macc_ps(mul0, mul1, r7);
            r8 = _mm256_macc_ps(mul0, mul1, r8);
            r9 = _mm256_macc_ps(mul0, mul1, r9);
            rA = _mm256_macc_ps(mul0, mul1, rA);
            rB = _mm256_macc_ps(mul0, mul1, rB);

            r0 = _mm256_nmacc_ps(mul0, mul1, r0);
            r1 = _mm256_nmacc_ps(mul0, mul1, r1);
            r2 = _mm256_nmacc_ps(mul0, mul1, r2);
            r3 = _mm256_nmacc_ps(mul0, mul1, r3);
            r4 = _mm256_nmacc_ps(mul0, mul1, r4);
            r5 = _mm256_nmacc_ps(mul0, mul1, r5);
            r6 = _mm256_nmacc_ps(mul0, mul1, r6);
            r7 = _mm256_nmacc_ps(mul0, mul1, r7);
            r8 = _mm256_nmacc_ps(mul0, mul1, r8);
            r9 = _mm256_nmacc_ps(mul0, mul1, r9);
            rA = _mm256_nmacc_ps(mul0, mul1, rA);
            rB = _mm256_nmacc_ps(mul0, mul1, rB);
